...
//	  savedist    = changes save distance script use to move away units under attack, set this to 200-300, when using the script in open areas (rural surroundings)
//
// =========================================================================================================

//#define __UPS_DEBUG__

#define __XENO_DOMINATION__
...
//hint format[ "+++ typename _obj = %1", typename _obj ];
...
#ifdef __UPS_DEBUG__
//hint format["+++ Marker pos:  %1, %2; w %3, h %4; type %5",_centerX, _centerY, _rangeX, _rangeY, getMarkerType _areamarker ];
format["+++ Marker:  %1, %2; w %3, h %4; type %5",_centerX, _centerY, _rangeX, _rangeY, getMarkerType _areamarker ] call XfGlobalChat;
#endif
...
//+++ Sygsky: change save distance 
_savedist = ["SAVEDIST:", _savedist, _UCthis] call KRON_UPSgetArg;

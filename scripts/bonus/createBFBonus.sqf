...
//	_veh = [+(_mt select 0), _mt select 2, _x] call SYG_createBonusVeh;
	...
	hint localize format["+++ DOSAAF: %1 created at %2!", _x, [_veh, localize "STR_SYS_POSE", 10] call SYG_MsgOnPosE ];
//	player groupChat format["+++ DOSAAF: %1 created at %2!", _x, [_veh, localize "STR_SYS_POSE", 10] call SYG_MsgOnPosE ];
	sleep 0.5;

...
["msg_to_user", "STR_SYS_251"] ; // "Отсутствует разрешение на полёты!";
...
if (! isPlayer ( leader _enterer ) ) exitWith {
	hint localize format["--- AI tries to getin as %1, no player owner detected and msg not sent", _position];
};

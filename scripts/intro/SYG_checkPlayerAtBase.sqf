...
if (!isNil "SYG_initialEquipmentStr") then {
	...
	[ "msg_to_user", "*", [["STR_INTRO_ON_BASE",name player]], 0, 2, false, "no_more_waiting" ] call XSendNetStartScriptClient; // Send to all others: "%1 have reached the base! Life will get easier from here."

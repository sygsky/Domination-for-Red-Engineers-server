...
if (base_visit_session <= 0) exitWith { playSound  "atmos"; hint localize "*** scripts/deathSound.sqf: playSound ""atmos.ogg"""}; // if we today still never visit the base, atmospheric sound is played
#endif

...
if (!alive player) exitWith { [ "msg_to_user", "*", ["localize", "STR_INTRO_NOT_AT_BASE"], 0, 0, false, "losing_patience" ] call SYG_msgToUserParser; }; // "You have not reached the base this time..."

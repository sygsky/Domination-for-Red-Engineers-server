/*
	...
	call as: _last_trget_id execVM "scripts\countTargetRuins.sqf";
	returns: nothing
*/
...
["msg_to_users","", [[_msg, _new_ruins_cnt], ["STR_SYS_650_2"]], 5,3,false, _sound] call XSendNetStartScriptClient;

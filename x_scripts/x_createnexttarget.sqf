...
hint localize format[ "+++ x_scripts/x_createnexttarget.sqf: current_target_index = %1, current_counter = %2", current_target_index, current_counter ];
...
#ifdef __DEBUG__
hint localize format["+++ x_createnexttarget.sqf (%1:%2) +++", _dummy select 1, current_counter];
#endif

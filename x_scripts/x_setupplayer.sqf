...
//	hint localize format["+++ _local_msg_arr count %1", count _this]; // DEBUG
    ...
    if ( (name player) in ["Ceres-de","CERES de","Ceres.","CERES"]) exitWith {
        ...
        [
            ...
            [
              ...
              ["Anfragen zum Einschalten des Servers sollten auf WhatsApp 8(916)136-2219 gesendet werden."], // "Requests to turn on the server should be sent to WhatsApp 8(916)136-2219."
    ...
    if ( (name player) == "Rokse [LT]") exitWith {
        ...
        [
            "msg_to_user",
            "",
            [ ["За заслуги в деле построения нашей миссии главный инженер выносит Вам благодарность, за внимание и глубокий поиск ошибок!!!" ] ],

...
#endif
		_vec_msg1 = localize "STR_SYS_325"; //"Это мобильный респаун. Используется для перевозки ящиков снабжения, респауна после смерти, телепортирования и выгрузки техники."
	} else {
#ifndef __TT__

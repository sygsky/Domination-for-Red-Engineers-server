...
*/
                    ...
                    // Check is vehicle recoverable or not, take veh locality into the account

#ifdef __OWN_SIDE_EAST__
                    _rec_msg = localize (if (_nearest call SYG_isEastVehicle) then {"STR_SYS_37_1"} else {"STR_SYS_37_0"}); // ", probably recoverable"/", not recoverable"
#else
                    _rec_msg = localize (if (_nearest call SYG_isWestVehicle) then {"STR_SYS_37_1"} else {"STR_SYS_37_0"}); // ", probably recoverable"/", not recoverable"
#endif

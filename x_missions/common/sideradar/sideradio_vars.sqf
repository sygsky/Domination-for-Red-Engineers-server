...
#define RADAR_POINT [10044,8030]       // debug radar point (near Somato at height 231)
#define INSTALL_RADIUS 100             // how far from the debug RADAR_POINT
...
#define MAX_SLOPE 0.15					// 0.15 m. per 3x3 m. area

...
private ["_angle","_angle_plus","_arti","_arti_pos_dir","_arti_type","_center_x","_center_y","count_items","_crewman","_grp","_i","_pos_array","_poss","_radius","_this","_truck","_trackType","_unit","_x1","_y1"];

...
if (X_Client) then {
	current_mission_text = "На вершине горы San Esteban расположилась вражеская артиллерия. Задача: уничтожить всю технику.";
	current_mission_resolved_text = "Задание выполнено! Артиллерия уничтожена.";
};

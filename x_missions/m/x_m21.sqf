...
if (X_Client) then {
	current_mission_text = format[localize "STR_SYS_500","Corazol","Estrella", d_ranked_a select 11]; //"The enemy has sent a convoy of supply, reinforced by armored vehicles, from %1 to %2. Your task: find and destroy all the machines, without any exception, including empty and upside down. If the mission fails, the penalty is -%3"

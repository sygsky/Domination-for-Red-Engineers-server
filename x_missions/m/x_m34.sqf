...
if (X_Client) then {
	current_mission_text = localize "STR_SM_34"; // "Высший офицерский состав расслабляется в городе Paraiso. Ваша задача взорвать электростанцию на востоке города, тем самым оставив их бордель без электричества.";
